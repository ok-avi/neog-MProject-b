...
const LeadList = () => {
  ...
  if (data) {
    ...
    if (sortByPriority==="lowToHigh") {
      filteredLeads.sort((a,b)=>priorityOrder[a.priority]-priorityOrder[b.priority])
    ...
    if(sortByTimeToClose==="latest"){
      ...
      filteredLeads = filteredLeads.sort((a,b)=>a.timeToClose-b.timeToClose).reverse()
      ...
      <main className="row">
        ...
        <section className="col-8 col-lg-9 py-4 px-5">
            ...
            {data &&
              ...
              filteredLeads.map((lead) => (
                <div className="row mb-2">
                  ...
                  <div className="col">
                    <Link to={`/status?name=${lead.status}`} className="nav-link d-inline link-hover">{lead.status}</Link>
                  </div>
          ...
          <section className="mb-3">
            ...
            <div className="row mb-3">
              ...
              <div className="col form-check">
                ...
                />
                <label htmlFor="lowToHigh" className="form-check-label border-bottom border-2">
                  Low to High
                </label>
              </div>
              <div className="col form-check">
                <input
                  ...
                  onChange={sortByPriorityHandler}
                />
                <label htmlFor="highToLow" className="form-check-label border-bottom border-2">
                  High to Low
                </label>
              </div>
            </div>
            <div className="row mb-3">
              ...
              <div className="col form-check">
                ...
                />
                <label htmlFor="latest" className="form-check-label border-bottom border-2">
                  Latest
                </label>
              </div>
              <div className="col form-check">
                <input
                  ...
                  onChange={sortByTimeToCloseHandler}
                />
                <label htmlFor="oldest" className="form-check-label border-bottom border-2">
                  Oldest
                </label>
              </div>
            </div>
          ...
          <section className="my-5">
            <Link to="/lead/form" className="btn btn-outline-danger px-5">Create new lead</Link>
          </section>
        </section>
      </main>
    </>
